...
.field public static final PARSE_IS_CLOUD_APK:I = 0x4000000
...
.method private parseActivity(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;I[Ljava/lang/String;ZZ)Landroid/content/pm/PackageParser$Activity;
    ...
    .line 2367
    .local v24, themeName:Ljava/lang/String;
    if-eqz v24, :cond_23
    ...
    .line 2377
    .end local v23           #themeId:I
    :cond_23
    iget-object v2, v14, Landroid/content/pm/PackageParser$Component;->metaData:Landroid/os/Bundle;

    const-string/jumbo v3, "simpleuimode"
    ...
    .line 2385
    .local v15, navigationHide:Ljava/lang/String;
    if-eqz v15, :cond_1c
    ...
    iput-boolean v3, v2, Landroid/content/pm/ActivityInfo;->navigationHide:Z
    ...
    const-string/jumbo v4, "parseactivity mAchrivePath is "
    ...
    const-string v4, " navigationHide is "
    ...
    .line 2392
    .end local v15           #navigationHide:Ljava/lang/String;
    .end local v16           #needSUIMode:Z
    .end local v24           #themeName:Ljava/lang/String;
    :cond_25
    const-string v2, "PackageParser"
...
.method private parseActivityAlias(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;I[Ljava/lang/String;)Landroid/content/pm/PackageParser$Activity;
    ...
    .line 2430
    .local v27, targetActivity:Ljava/lang/String;
    if-nez v27, :cond_1
    ...
    .line 2461
    .local v26, target:Landroid/content/pm/PackageParser$Activity;
    move-object/from16 v0, p1
    ...
    .line 2464
    .local v25, t:Landroid/content/pm/PackageParser$Activity;
    ...
    .line 2470
    .end local v25           #t:Landroid/content/pm/PackageParser$Activity;
    :cond_4
    if-nez v26, :cond_6
    ...
    .line 2462
    .restart local v25       #t:Landroid/content/pm/PackageParser$Activity;
    :cond_5
    ...
    .line 2514
    .end local v21           #parentName:Ljava/lang/String;
    :cond_c
    const/4 v2, 0x0
    ...
    .restart local v21       #parentName:Ljava/lang/String;
    :cond_d
    const-string v2, "PackageParser"
    ...
    .line 2565
    :cond_14
    iget-object v2, v15, Landroid/content/pm/PackageParser$Component;->metaData:Landroid/os/Bundle;
