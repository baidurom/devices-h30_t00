...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    const-string v7, "android.net.conn.USB_INTERNET_SYSTEM_KEY"
    ...
    invoke-static {v5, v7}, Landroid/net/UsbDataStateTracker;->access$502(Landroid/net/UsbDataStateTracker;I)I
    ...
    invoke-static {v5, v6, v3, v0}, Landroid/net/UsbDataStateTracker;->access$600(Landroid/net/UsbDataStateTracker;Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, v5}, Landroid/net/UsbDataStateTracker;->access$702(Landroid/net/UsbDataStateTracker;Landroid/net/LinkProperties;)Landroid/net/LinkProperties;

    .line 254
    iget-object v5, p0, Landroid/net/UsbDataStateTracker$UsbDataStateReceiver;->this$0:Landroid/net/UsbDataStateTracker;

    #getter for: Landroid/net/UsbDataStateTracker;->mLinkProperties:Landroid/net/LinkProperties;
    invoke-static {v5}, Landroid/net/UsbDataStateTracker;->access$700(Landroid/net/UsbDataStateTracker;)Landroid/net/LinkProperties;
    ...
    #setter for: Landroid/net/UsbDataStateTracker;->mLinkProperties:Landroid/net/LinkProperties;
    invoke-static {v5, v6}, Landroid/net/UsbDataStateTracker;->access$702(Landroid/net/UsbDataStateTracker;Landroid/net/LinkProperties;)Landroid/net/LinkProperties;
    ...
    invoke-static {v6, v5}, Landroid/net/UsbDataStateTracker;->access$902(Landroid/net/UsbDataStateTracker;Landroid/net/LinkCapabilities;)Landroid/net/LinkCapabilities;

    .line 263
    iget-object v5, p0, Landroid/net/UsbDataStateTracker$UsbDataStateReceiver;->this$0:Landroid/net/UsbDataStateTracker;

    #getter for: Landroid/net/UsbDataStateTracker;->mLinkCapabilities:Landroid/net/LinkCapabilities;
    invoke-static {v5}, Landroid/net/UsbDataStateTracker;->access$900(Landroid/net/UsbDataStateTracker;)Landroid/net/LinkCapabilities;
    ...
    #setter for: Landroid/net/UsbDataStateTracker;->mLinkCapabilities:Landroid/net/LinkCapabilities;
    invoke-static {v5, v6}, Landroid/net/UsbDataStateTracker;->access$902(Landroid/net/UsbDataStateTracker;Landroid/net/LinkCapabilities;)Landroid/net/LinkCapabilities;
    ...
    invoke-static {v5}, Landroid/net/UsbDataStateTracker;->access$1000(Landroid/net/UsbDataStateTracker;)Landroid/os/Handler;
    ...
    invoke-static {v5}, Landroid/net/UsbDataStateTracker;->access$1100(Landroid/net/UsbDataStateTracker;)V
