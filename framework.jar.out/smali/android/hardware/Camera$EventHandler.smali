...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string/jumbo v12, "mLcdCompensateCallback: "
    ...
    invoke-static {v12}, Landroid/hardware/Camera;->access$2000(Landroid/hardware/Camera;)Landroid/hardware/Camera$LcdCompensateCallback;
    ...
    #getter for: Landroid/hardware/Camera;->mLcdCompensateCallback:Landroid/hardware/Camera$LcdCompensateCallback;
    invoke-static {v10}, Landroid/hardware/Camera;->access$2000(Landroid/hardware/Camera;)Landroid/hardware/Camera$LcdCompensateCallback;
    ...
    invoke-interface {v10, v11}, Landroid/hardware/Camera$LcdCompensateCallback;->onLcdCompensate(Landroid/hardware/Camera;)V
    ...
    invoke-static {v10}, Landroid/hardware/Camera;->access$2100(Landroid/hardware/Camera;)Landroid/hardware/Camera$AUTORAMAMVCallback;
    ...
    invoke-static {v12}, Landroid/hardware/Camera;->access$2200(Landroid/hardware/Camera;)Landroid/hardware/Camera$AUTORAMACallback;
    ...
    #getter for: Landroid/hardware/Camera;->mAUTORAMACallback:Landroid/hardware/Camera$AUTORAMACallback;
    invoke-static {v10}, Landroid/hardware/Camera;->access$2200(Landroid/hardware/Camera;)Landroid/hardware/Camera$AUTORAMACallback;
    ...
    invoke-static {v10}, Landroid/hardware/Camera;->access$2300(Landroid/hardware/Camera;)Landroid/hardware/Camera$AFDataCallback;
