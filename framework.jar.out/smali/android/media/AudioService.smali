...
.field private static final DTS_MUSIC:I = 0x1
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-wide v2, v0, Landroid/media/AudioService;->mLastRecordTime:J

    .line 248
    const-string/jumbo v2, "ro.config.hw.security_volume"
    ...
    iput v2, v0, Landroid/media/AudioService;->mLimitedVolume:I
    ...
    iput-boolean v2, v0, Landroid/media/AudioService;->mEarPhoneOn:Z
    ...
    iput-object v2, v0, Landroid/media/AudioService;->mAlertDialog:Landroid/app/AlertDialog;

    .line 256
    const-string v2, "android.intent.action.SHOW_SCURITY_DIALOG"

    move-object/from16 v0, p0

    iput-object v2, v0, Landroid/media/AudioService;->mDialogAction:Ljava/lang/String;

    .line 257
    const-string v2, "android.intent.action.DELETE_SECURITY_NOTIFICATON"

    move-object/from16 v0, p0

    iput-object v2, v0, Landroid/media/AudioService;->mDeleteNotification:Ljava/lang/String;
    ...
    iput-boolean v2, v0, Landroid/media/AudioService;->mShowDialog:Z
    ...
    iput-boolean v2, v0, Landroid/media/AudioService;->mDialogShowing:Z
    ...
    iput-object v2, v0, Landroid/media/AudioService;->mOldconfig:Landroid/content/res/Configuration;
    ...
    .line 5135
    new-instance v2, Landroid/media/AudioService$5;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Landroid/media/AudioService$5;-><init>(Landroid/media/AudioService;)V
    ...
    .line 542
    new-instance v2, Landroid/media/AudioService$AudioServicesEx;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Landroid/media/AudioService$AudioServicesEx;-><init>(Landroid/media/AudioService;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Landroid/media/AudioService;->audioServiceEx:Landroid/media/AudioService$AudioServicesEx;
    ...
    iget-object v2, v0, Landroid/media/AudioService;->mDialogAction:Ljava/lang/String;
    ...
    iget-object v2, v0, Landroid/media/AudioService;->mDeleteNotification:Ljava/lang/String;
    ...
    .line 635
    const-string v2, "com.android.huawei.ENABLE_AUDIO_SAFECHECK"
    ...
    iget-object v2, v0, Landroid/media/AudioService;->mAudioManager:Landroid/media/AudioManager;

    const-string/jumbo v3, "srs_cfg:trumedia_enable=1"
    ...
    const-string/jumbo v3, "srs_cfg:vol_int_enable=1"
    ...
    const-string/jumbo v3, "srs_cfg:trumedia_preset=0"
    ...
    const-string/jumbo v3, "srs_cfg:trumedia_enable=0"
...
.method static synthetic access$10500(Landroid/media/AudioService;Z)V
    ...
    .prologue
    .line 133
    invoke-direct {p0, p1}, Landroid/media/AudioService;->setSafeMediaVolumeEnabled(Z)V
...
.method static synthetic access$10700(Landroid/media/AudioService;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$10800(Landroid/media/AudioService;)Landroid/media/AudioManager;
    .locals 1
    .parameter "x0"
...
.method private handleConfigurationChanged(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, v10}, Landroid/content/res/Configuration;->diff(Landroid/content/res/Configuration;)I

    move-result v11

    .line 6298
    .local v11, configChanges:I
    ...
    invoke-virtual {v1, v10}, Landroid/content/res/Configuration;->setTo(Landroid/content/res/Configuration;)V

    .line 6308
    .end local v11           #configChanges:I
    .end local v13           #hwthemechg:Z
    .end local v14           #localechg:Z
    :cond_2
    move-object/from16 v0, p0
    ...
    .line 6309
    iget v15, v10, Landroid/content/res/Configuration;->orientation:I

    .line 6310
    .local v15, newOrientation:I
    move-object/from16 v0, p0
    ...
    iput v15, v0, Landroid/media/AudioService;->mDeviceOrientation:I

    .line 6312
    invoke-direct/range {p0 .. p0}, Landroid/media/AudioService;->setOrientationForAudioSystem()V

    .line 6315
    .end local v15           #newOrientation:I
    :cond_3
    move-object/from16 v0, p0
    ...
    .line 6345
    invoke-virtual/range {v16 .. v16}, Landroid/media/AudioService$VolumeStreamState;->setAllIndexesToMax()V
    ...
    .restart local v11       #configChanges:I
    :cond_6
    const/4 v13, 0x0
    ...
    .line 6300
    .restart local v13       #hwthemechg:Z
    :cond_7
    const/4 v14, 0x0
...
.method private handleDeviceConnection(ZILjava/lang/String;)Z
    ...
    const-string v7, "handleDeviceConnection:isConnected"
    ...
    const-string v6, "handleDeviceConnection remove:connected:"
    ...
    const-string v6, "handleDeviceConnection connect:connected:"
...
.method private sendVolumeUpdate(IIII)V
    ...
    .line 1256
    invoke-direct {p0, v5, v6, v7}, Landroid/media/AudioService;->sendMsgForSecurity(IJ)V
...
.method public isMediaStreamActiveForDtsEffect()Z
    .locals 2
...
.method public requestAudioFocus(IILandroid/os/IBinder;Landroid/media/IAudioFocusDispatcher;Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v1, v0, v2}, Landroid/util/LogPower;->spush(ILjava/lang/String;Ljava/lang/String;)I
...
.method public setSpeakermediaOn(Z)V
    ...
    const-string/jumbo v2, "setSpeakermediaOn "
    ...
    .end local v4           #mForcedUseForMedia:I
    :cond_1
    move v4, v6
...
.method public setStreamVolume(III)V
    ...
    .line 1111
    invoke-direct {p0, p1, v7, v7, p3}, Landroid/media/AudioService;->sendVolumeUpdate(IIII)V
