...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/widget/RemoteViews$SetOnLongClickFillInIntent;,
...
.method private constructor <init>(Landroid/os/Parcel;Landroid/widget/RemoteViews$BitmapCache;)V
    ...
    new-instance v5, Landroid/widget/RemoteViews$SetOnLongClickFillInIntent;

    invoke-direct {v5, p0, p1}, Landroid/widget/RemoteViews$SetOnLongClickFillInIntent;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;)V
...
.method public apply(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/widget/RemoteViews$OnClickHandler;)Landroid/view/View;
    ...
    .line 2490
    invoke-virtual {v3, p0}, Landroid/view/LayoutInflater;->setFilter(Landroid/view/LayoutInflater$Filter;)V
    ...
    .line 2497
    invoke-direct {p0, p1, v3}, Landroid/widget/RemoteViews;->setWidgetFactoryHuaWei(Landroid/content/Context;Landroid/view/LayoutInflater;)V
    ...
    invoke-virtual {v3, v7, p2, v6}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    move-result-object v4

    .line 2503
    .local v4, result:Landroid/view/View;
    invoke-direct {v5, v4, p2, p3}, Landroid/widget/RemoteViews;->performApply(Landroid/view/View;Landroid/view/ViewGroup;Landroid/widget/RemoteViews$OnClickHandler;)V
    ...
    iget v2, v7, Landroid/content/pm/ApplicationInfo;->flags:I
...
.method public setOnLongClickFillInIntent(ILandroid/content/Intent;)V
    .locals 1
    .parameter "viewId"
    .parameter "fillInIntent"
    ...
    .prologue
    .line 2160
    new-instance v0, Landroid/widget/RemoteViews$SetOnLongClickFillInIntent;

    invoke-direct {v0, p0, p1, p2}, Landroid/widget/RemoteViews$SetOnLongClickFillInIntent;-><init>(Landroid/widget/RemoteViews;ILandroid/content/Intent;)V
...
.method public setOnLongClickPendingIntent(ILandroid/app/PendingIntent;)V
    .locals 1
    .parameter "viewId"
    .parameter "pendingIntent"
    ...
    invoke-direct {v0, p0, p1, p2}, Landroid/widget/RemoteViews$SetOnLongClickPendingIntent;-><init>(Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;)V
