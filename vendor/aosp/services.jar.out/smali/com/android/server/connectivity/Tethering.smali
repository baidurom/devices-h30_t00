...
.field mShowMTKHotSpotManager:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/IConnectivityManager;Landroid/os/Looper;)V
    ...
    .line 167
    iput-boolean v3, p0, Lcom/android/server/connectivity/Tethering;->mTetheredFail:Z

    .line 177
    iput-boolean v3, p0, Lcom/android/server/connectivity/Tethering;->mUsbTetherEnabled:Z

    .line 181
    iput-boolean v2, p0, Lcom/android/server/connectivity/Tethering;->mIsTetheringChangeDone:Z

    .line 212
    iput-boolean v3, p0, Lcom/android/server/connectivity/Tethering;->mShowMTKHotSpotManager:Z
    ...
    iput-object v4, p0, Lcom/android/server/connectivity/Tethering;->mIpv6IfaceObserver:Landroid/net/INetworkManagementIpv6EventObserver;
    ...
    const-string v5, "Ipv6TetherMaster"

    iget-object v6, p0, Lcom/android/server/connectivity/Tethering;->mLooper:Landroid/os/Looper;

    invoke-direct {v4, p0, v5, v6}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;-><init>(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;Landroid/os/Looper;)V

    iput-object v4, p0, Lcom/android/server/connectivity/Tethering;->mIpv6TetherMasterSM:Lcom/android/internal/util/StateMachine;

    .line 236
    iget-object v4, p0, Lcom/android/server/connectivity/Tethering;->mIpv6TetherMasterSM:Lcom/android/internal/util/StateMachine;
    ...
    .line 247
    iput v3, p0, Lcom/android/server/connectivity/Tethering;->mUsbInternetState:I
    ...
    iput-object v4, p0, Lcom/android/server/connectivity/Tethering;->mNotificationSync:Ljava/lang/Object;
    ...
    iput-object v4, p0, Lcom/android/server/connectivity/Tethering;->mWifiIface:Ljava/lang/String;

    .line 273
    iput-boolean v3, p0, Lcom/android/server/connectivity/Tethering;->mUsbInternetEnable:Z

    .line 274
    iput v3, p0, Lcom/android/server/connectivity/Tethering;->mUsbInternetSystemType:I
    ...
    iput-object v4, p0, Lcom/android/server/connectivity/Tethering;->mUsbInternetGateway:Ljava/lang/String;

    .line 276
    new-array v4, v7, [Ljava/lang/String;

    iput-object v4, p0, Lcom/android/server/connectivity/Tethering;->mUsbInternetDnsServers:[Ljava/lang/String;

    .line 277
    iget-object v4, p0, Lcom/android/server/connectivity/Tethering;->mUsbInternetDnsServers:[Ljava/lang/String;

    sget-object v5, Lcom/android/server/connectivity/Tethering;->USB_INTERNET_DNS_SERVER1:[Ljava/lang/String;
    ...
    const-string v5, "168.95.1.1"

    aput-object v5, v4, v2

    .line 282
    :try_start_0
    iget-object v4, p0, Lcom/android/server/connectivity/Tethering;->mIpv6IfaceObserver:Landroid/net/INetworkManagementIpv6EventObserver;

    invoke-interface {p2, v4}, Landroid/os/INetworkManagementService;->registerIpv6Observer(Landroid/net/INetworkManagementIpv6EventObserver;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    .line 289
    :goto_0
    new-instance v4, Lcom/android/server/connectivity/Tethering$NotificationEnabledSettingObserver;

    new-instance v5, Landroid/os/Handler;

    invoke-direct {v5}, Landroid/os/Handler;-><init>()V

    invoke-direct {v4, p0, v5}, Lcom/android/server/connectivity/Tethering$NotificationEnabledSettingObserver;-><init>(Lcom/android/server/connectivity/Tethering;Landroid/os/Handler;)V

    iput-object v4, p0, Lcom/android/server/connectivity/Tethering;->mNotificationEnabledSettingObserver:Lcom/android/server/connectivity/Tethering$NotificationEnabledSettingObserver;

    .line 290
    iget-object v4, p0, Lcom/android/server/connectivity/Tethering;->mNotificationEnabledSettingObserver:Lcom/android/server/connectivity/Tethering$NotificationEnabledSettingObserver;

    invoke-virtual {v4}, Lcom/android/server/connectivity/Tethering$NotificationEnabledSettingObserver;->register()V
    ...
    const-string v5, "hw_show_mtk_hotspot_manager"

    invoke-static {v4, v5, v3}, Landroid/provider/SettingsEx$Systemex;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    :goto_1
    iput-boolean v2, p0, Lcom/android/server/connectivity/Tethering;->mShowMTKHotSpotManager:Z
...
.method static synthetic access$3502(Lcom/android/server/connectivity/Tethering;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$6500(Lcom/android/server/connectivity/Tethering;I)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$6800(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method private showTetheredNotification(ILjava/lang/String;)V
    ...
    const-string v4, " mShowMTKHotSpotManager: "
    ...
    iget-boolean v4, v0, Lcom/android/server/connectivity/Tethering;->mShowMTKHotSpotManager:Z
    ...
    iget-boolean v1, v0, Lcom/android/server/connectivity/Tethering;->mShowMTKHotSpotManager:Z
...
.method private updateTetheredNotification()V
    ...
    const-string v20, "updateTetheredNotification"
    ...
    invoke-virtual {v0, v9}, Lcom/android/server/connectivity/Tethering;->isWifi(Ljava/lang/String;)Z
    ...
    const-string v21, "INTERFACE_THROTTLE::onChange,wifiTethered = "
    ...
    iget-boolean v0, v0, Lcom/android/server/connectivity/Tethering;->mShowMTKHotSpotManager:Z
    ...
    .line 838
    .local v12, mgr:Landroid/net/wifi/WifiManager;
    if-eqz v13, :cond_4
    ...
    .end local v12           #mgr:Landroid/net/wifi/WifiManager;
    ...
    .restart local v12       #mgr:Landroid/net/wifi/WifiManager;
    ...
    invoke-virtual {v13, v0, v1, v2, v3}, Landroid/app/NotificationManager;->notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V
