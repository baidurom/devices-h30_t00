...
.method public processMessage(Landroid/os/Message;)Z
    ...
    const-string v10, "Unexpected loss of p2p socket connection"
    ...
    invoke-static {v10}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$1600(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$P2pDisabledState;

    move-result-object v10

    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v9, v10}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$3600(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-virtual {v9}, Landroid/net/wifi/p2p/WifiP2pGroupList;->clear()Z
    ...
    invoke-static {v9}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$300(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)V
    ...
    invoke-virtual {v9}, Landroid/net/wifi/WifiNative;->stopDriver()Z
    ...
    invoke-virtual {v9}, Landroid/net/wifi/WifiNative;->closeSupplicantConnection()V
    ...
    invoke-static {v10}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$3800(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$P2pDisablingState;

    move-result-object v10

    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v9, v10}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$3900(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Lcom/android/internal/util/IState;)V
    ...
    const-string/jumbo v11, "set device name "
    ...
    invoke-static {v9, v10}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$4300(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Z)V
    ...
    invoke-virtual {v9, v2}, Landroid/net/wifi/p2p/WifiP2pDeviceList;->update(Landroid/net/wifi/p2p/WifiP2pDevice;)V
    ...
    const-string v11, "P2P_DEVICE_FOUND_EVENT Fast connect GC enableState:"
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mGcFastConnectEnaled:Z
    invoke-static {v11}, Landroid/net/wifi/p2p/WifiP2pService;->access$2700(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    invoke-static {v11}, Landroid/net/wifi/p2p/WifiP2pService;->access$4600(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mGcFastConnectEnaled:Z
    invoke-static {v9}, Landroid/net/wifi/p2p/WifiP2pService;->access$2700(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mFoundGoTimeOut:Z
    invoke-static {v9}, Landroid/net/wifi/p2p/WifiP2pService;->access$4600(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    const-string v11, "Found Fast connect peer:"
    ...
    invoke-static {v9, v10}, Landroid/net/wifi/p2p/WifiP2pService;->access$4702(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    invoke-virtual {v9, v2}, Landroid/net/wifi/p2p/WifiP2pDeviceList;->remove(Landroid/net/wifi/p2p/WifiP2pDevice;)Z
    ...
    invoke-static {v9, v10, v7}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$4800(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Messenger;Landroid/net/wifi/p2p/nsd/WifiP2pServiceInfo;)Z
    ...
    const-string v11, " remove service"
    ...
    invoke-static {v9, v10, v7}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$4900(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Messenger;Landroid/net/wifi/p2p/nsd/WifiP2pServiceInfo;)V
    ...
    const-string v11, " clear service"
    ...
    invoke-static {v9, v10}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$5000(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Messenger;)V
    ...
    const-string v11, " add service request"
    ...
    check-cast v9, Landroid/net/wifi/p2p/nsd/WifiP2pServiceRequest;
    ...
    invoke-static {v10, v11, v9}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$5100(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Messenger;Landroid/net/wifi/p2p/nsd/WifiP2pServiceRequest;)Z
    ...
    const-string v11, " remove service request"
    ...
    invoke-static {v10, v11, v9}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$5200(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Messenger;Landroid/net/wifi/p2p/nsd/WifiP2pServiceRequest;)V
    ...
    const-string v11, " clear service request"
    ...
    invoke-static {v9, v10}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$5300(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Messenger;)V
    ...
    const-string v11, " receive service response"
    ...
    invoke-static {v9, v5}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$5400(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/nsd/WifiP2pServiceResponse;)V
    ...
    const-string v11, " delete persistent group"
    ...
    invoke-virtual {v9, v10}, Landroid/net/wifi/p2p/WifiP2pGroupList;->remove(I)V
    ...
    const-string v11, " Send fast connect loop scan OK"
    ...
    invoke-virtual {v9, v10, v11, v12}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->sendMessageDelayed(IJ)V
    ...
    const-string v11, " Fast connect scan OK"
    ...
    const-string v11, " fast connect loop scan stop"
    ...
    const-string v11, " Fast connect scan Fail"
    ...
    check-cast v4, Landroid/net/wifi/p2p/wfd/WfdLinkInfo;

    .line 1139
    .local v4, info:Landroid/net/wifi/p2p/wfd/WfdLinkInfo;
    iget-object v9, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$P2pEnabledState;->this$1:Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;
    ...
    iget-object v10, v4, Landroid/net/wifi/p2p/wfd/WfdLinkInfo;->interfaceAddress:Ljava/lang/String;

    invoke-virtual {v9, v10}, Landroid/net/wifi/WifiNative;->wfdLinkStatics(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    iput-object v9, v4, Landroid/net/wifi/p2p/wfd/WfdLinkInfo;->linkInfo:Ljava/lang/String;
    ...
    const-string v11, "Wfd link info is "

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    invoke-virtual {v4}, Landroid/net/wifi/p2p/wfd/WfdLinkInfo;->toString()Ljava/lang/String;
    ...
    new-instance v11, Landroid/net/wifi/p2p/wfd/WfdLinkInfo;

    invoke-direct {v11, v4}, Landroid/net/wifi/p2p/wfd/WfdLinkInfo;-><init>(Landroid/net/wifi/p2p/wfd/WfdLinkInfo;)V

    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->replyToMessage(Landroid/os/Message;ILjava/lang/Object;)V
    invoke-static {v9, p1, v10, v11}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$900(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Message;ILjava/lang/Object;)V

    goto/16 :goto_2

    .line 1144
    .end local v4           #info:Landroid/net/wifi/p2p/wfd/WfdLinkInfo;
    :sswitch_15
    ...
    invoke-virtual {v9, v8}, Landroid/net/wifi/WifiNative;->wfdSessionMode(I)Ljava/lang/String;
    ...
    invoke-virtual {v9}, Landroid/net/wifi/WifiNative;->wfdUpdate()Ljava/lang/String;
