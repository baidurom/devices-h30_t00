...
# instance fields
.field private mAudioRecordPermission:Lcom/huawei/permission/AudioRecordPermission;
...
.method public constructor <init>()V
    ...
    .line 106
    iput-object v1, p0, Landroid/media/MediaRecorder;->mCameraPermission:Lcom/huawei/permission/CameraPermission;

    .line 107
    iput-object v1, p0, Landroid/media/MediaRecorder;->mAudioRecordPermission:Lcom/huawei/permission/AudioRecordPermission;
...
.method public native native_setVideoSource(I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalStateException;
        }
...
.method public prepare()V
    ...
    .line 734
    iget-object v0, p0, Landroid/media/MediaRecorder;->mCameraPermission:Lcom/huawei/permission/CameraPermission;

    if-nez v0, :cond_0

    .line 735
    new-instance v0, Lcom/huawei/permission/AudioRecordPermission;

    invoke-direct {v0}, Lcom/huawei/permission/AudioRecordPermission;-><init>()V

    iput-object v0, p0, Landroid/media/MediaRecorder;->mAudioRecordPermission:Lcom/huawei/permission/AudioRecordPermission;

    .line 736
    iget-object v0, p0, Landroid/media/MediaRecorder;->mAudioRecordPermission:Lcom/huawei/permission/AudioRecordPermission;

    invoke-virtual {v0}, Lcom/huawei/permission/AudioRecordPermission;->remind()V
...
.method public setLocation(FF)V
    ...
    .line 485
    :cond_0
    const-string v2, "Latitude out of range."
    ...
    .line 491
    :cond_2
    const-string v2, "Longitude out of range"
...
.method public setPreviewDisplay(Landroid/view/Surface;)V
    ...
    .line 158
    :try_start_0
    iget-object v1, p0, Landroid/media/MediaRecorder;->mCameraPermission:Lcom/huawei/permission/CameraPermission;
    ...
    invoke-direct {v1}, Lcom/huawei/permission/CameraPermission;-><init>()V
    ...
    iget-boolean v1, v1, Lcom/huawei/permission/CameraPermission;->isCameraBlocked:Z
    ...
    iput-object v1, p0, Landroid/media/MediaRecorder;->mSurface:Landroid/view/Surface;
...
.method public setVideoSource(I)V
    ...
    invoke-direct {v0}, Lcom/huawei/permission/CameraPermission;-><init>()V

    iput-object v0, p0, Landroid/media/MediaRecorder;->mCameraPermission:Lcom/huawei/permission/CameraPermission;

    .line 379
    iget-object v0, p0, Landroid/media/MediaRecorder;->mCameraPermission:Lcom/huawei/permission/CameraPermission;

    invoke-virtual {v0}, Lcom/huawei/permission/CameraPermission;->remind()V

    .line 381
    :cond_0
    invoke-virtual {p0, p1}, Landroid/media/MediaRecorder;->native_setVideoSource(I)V
...
.method public stop()V
    ...
    .line 786
    iget-object v3, p0, Landroid/media/MediaRecorder;->mAudioRecordPermission:Lcom/huawei/permission/AudioRecordPermission;

    if-eqz v3, :cond_0

    iget-object v3, p0, Landroid/media/MediaRecorder;->mAudioRecordPermission:Lcom/huawei/permission/AudioRecordPermission;

    iget-boolean v3, v3, Lcom/huawei/permission/AudioRecordPermission;->isAudioRecordBlocked:Z

    if-nez v3, :cond_1

    :cond_0
    iget-object v3, p0, Landroid/media/MediaRecorder;->mCameraPermission:Lcom/huawei/permission/CameraPermission;

    if-eqz v3, :cond_3

    iget-object v3, p0, Landroid/media/MediaRecorder;->mCameraPermission:Lcom/huawei/permission/CameraPermission;

    iget-boolean v3, v3, Lcom/huawei/permission/CameraPermission;->isCameraBlocked:Z
    ...
    .line 797
    invoke-static {}, Lcom/huawei/permission/AudioRecordPermission;->getData()[B
    ...
    .restart local v1       #fos:Ljava/io/FileOutputStream;
    :cond_4
    iget-object v3, p0, Landroid/media/MediaRecorder;->mFd:Ljava/io/FileDescriptor;
