...
.method private checkPermission(Landroid/net/Uri;I)Z
    .locals 6
    .parameter "uri"
    .parameter "action"
    ...
    .line 2044
    new-instance v1, Lcom/huawei/permission/ContentPermission;

    iget-object v4, p0, Landroid/content/ContentResolver;->mContext:Landroid/content/Context;

    invoke-direct {v1, v4}, Lcom/huawei/permission/ContentPermission;-><init>(Landroid/content/Context;)V

    .line 2045
    .local v1, contentPermission:Lcom/huawei/permission/ContentPermission;
    invoke-virtual {v1, p1, p2}, Lcom/huawei/permission/ContentPermission;->getContentType(Landroid/net/Uri;I)I

    move-result v0

    .line 2046
    .local v0, Authority:I
    if-nez v0, :cond_1
    ...
    invoke-virtual {v1, v4}, Lcom/huawei/permission/ContentPermission;->isGlobalSwitchOn(Landroid/database/Cursor;)Z
    ...
    .line 2058
    invoke-virtual {v1}, Lcom/huawei/permission/ContentPermission;->remind()I
...
.method private final getDummyResult(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/content/IContentProvider;)Landroid/database/Cursor;
    ...
    invoke-direct {p0, v0}, Landroid/content/ContentResolver;->isBeginWithRightBrace(Ljava/lang/String;)Z
...
.method private isBeginWithRightBrace(Ljava/lang/String;)Z
    .locals 3
    .parameter "selection"
...
.method public applyBatch(Ljava/lang/String;Ljava/util/ArrayList;)[Landroid/content/ContentProviderResult;
    ...
    .line 953
    .local v1, allowedOperations:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/content/ContentProviderOperation;>;"
    ...
    invoke-virtual {v3}, Landroid/content/ContentProviderOperation;->getType()I
    ...
    invoke-direct {p0, v6, v0}, Landroid/content/ContentResolver;->checkPermission(Landroid/net/Uri;I)Z
    ...
    .end local v1           #allowedOperations:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/content/ContentProviderOperation;>;"
    .end local v2           #i$:Ljava/util/Iterator;
    ...
    .restart local v1       #allowedOperations:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/content/ContentProviderOperation;>;"
    .restart local v2       #i$:Ljava/util/Iterator;
    ...
    :cond_2
    :try_start_1
    invoke-virtual {v4, v1}, Landroid/content/ContentProviderClient;->applyBatch(Ljava/util/ArrayList;)[Landroid/content/ContentProviderResult;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public final bulkInsert(Landroid/net/Uri;[Landroid/content/ContentValues;)I
    ...
    :try_start_0
    invoke-direct {p0, p1, v0}, Landroid/content/ContentResolver;->checkPermission(Landroid/net/Uri;I)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    invoke-direct {v0, v1, v3}, Landroid/content/ContentResolver;->checkPermission(Landroid/net/Uri;I)Z
    ...
    .line 415
    .local v26, stackTrace:Ljava/lang/Throwable;
    ...
    invoke-virtual {v0, v3, v1, v4}, Landroid/content/ContentResolver;->AddToQueryHistory(Ljava/lang/String;Ljava/lang/Throwable;I)Z
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    .catch Landroid/os/RemoteException; {:try_start_3 .. :try_end_3} :catch_1
    ...
    .line 410
    .end local v26           #stackTrace:Ljava/lang/Throwable;
    ...
    const-string v5, "IllegalStateException handle:  ("

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    invoke-virtual/range {v24 .. v24}, Ljava/lang/IllegalStateException;->getMessage()Ljava/lang/String;
