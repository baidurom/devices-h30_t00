...
.field private final mContextEmui:Landroid/view/ContextThemeWrapper;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Landroid/server/BluetoothService;->mStateChangeTracker:Ljava/util/Map;

    .line 202
    const-string v3, "android.server.BluetoothService.action.DISCOVERABLE_TIMEOUT"

    iput-object v3, p0, Landroid/server/BluetoothService;->ACTION_DISCOVERABLE_TIMEOUT:Ljava/lang/String;
    ...
    .line 216
    iput-boolean v6, p0, Landroid/server/BluetoothService;->mAllowConnect:Z

    .line 217
    iput-boolean v5, p0, Landroid/server/BluetoothService;->mAllowUpdateProfileState:Z

    .line 219
    iput v5, p0, Landroid/server/BluetoothService;->mAdapterConnectionState:I

    .line 228
    iput-boolean v5, p0, Landroid/server/BluetoothService;->mSSPDebugMode:Z

    .line 784
    new-instance v3, Landroid/server/BluetoothService$2;

    invoke-direct {v3, p0}, Landroid/server/BluetoothService$2;-><init>(Landroid/server/BluetoothService;)V

    iput-object v3, p0, Landroid/server/BluetoothService;->mHandler:Landroid/os/Handler;

    .line 2111
    new-instance v3, Landroid/server/BluetoothService$3;

    invoke-direct {v3, p0}, Landroid/server/BluetoothService$3;-><init>(Landroid/server/BluetoothService;)V

    iput-object v3, p0, Landroid/server/BluetoothService;->mReceiver:Landroid/content/BroadcastReceiver;

    .line 2456
    new-instance v3, Landroid/server/BluetoothService$4;

    invoke-direct {v3, p0}, Landroid/server/BluetoothService$4;-><init>(Landroid/server/BluetoothService;)V

    iput-object v3, p0, Landroid/server/BluetoothService;->mBluetoothProfileServiceListener:Landroid/bluetooth/BluetoothProfile$ServiceListener;

    .line 268
    const-string v3, "[API] BluetoothService"
    ...
    invoke-direct {v3, v4}, Lcom/huawei/permission/WirelessAndNetworkPermission;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Landroid/server/BluetoothService;->mWirelessAndNetworkPermission:Lcom/huawei/permission/WirelessAndNetworkPermission;
    ...
    iput-object v3, p0, Landroid/server/BluetoothService;->mContextEmui:Landroid/view/ContextThemeWrapper;
    ...
    iput-object v3, p0, Landroid/server/BluetoothService;->mBatteryStats:Lcom/android/internal/app/IBatteryStats;
    ...
    iput-object v3, p0, Landroid/server/BluetoothService;->mUserSwitchedThread:Landroid/os/HandlerThread;
    ...
    .line 294
    new-instance v3, Landroid/server/BluetoothService$UserSwitchedHandler;

    iget-object v4, p0, Landroid/server/BluetoothService;->mUserSwitchedThread:Landroid/os/HandlerThread;

    invoke-virtual {v4}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v4

    invoke-direct {v3, p0, v4}, Landroid/server/BluetoothService$UserSwitchedHandler;-><init>(Landroid/server/BluetoothService;Landroid/os/Looper;)V

    iput-object v3, p0, Landroid/server/BluetoothService;->mUserSwitchedHandler:Landroid/server/BluetoothService$UserSwitchedHandler;

    .line 296
    new-instance v3, Landroid/server/BluetoothBondState;

    invoke-direct {v3, p1, p0}, Landroid/server/BluetoothBondState;-><init>(Landroid/content/Context;Landroid/server/BluetoothService;)V

    iput-object v3, p0, Landroid/server/BluetoothService;->mBondState:Landroid/server/BluetoothBondState;

    .line 297
    new-instance v3, Landroid/server/BluetoothAdapterProperties;

    invoke-direct {v3, p1, p0}, Landroid/server/BluetoothAdapterProperties;-><init>(Landroid/content/Context;Landroid/server/BluetoothService;)V

    iput-object v3, p0, Landroid/server/BluetoothService;->mAdapterProperties:Landroid/server/BluetoothAdapterProperties;

    .line 298
    new-instance v3, Landroid/server/BluetoothDeviceProperties;

    invoke-direct {v3, p0}, Landroid/server/BluetoothDeviceProperties;-><init>(Landroid/server/BluetoothService;)V

    iput-object v3, p0, Landroid/server/BluetoothService;->mDeviceProperties:Landroid/server/BluetoothDeviceProperties;
    ...
    iput-object v3, p0, Landroid/server/BluetoothService;->mDeviceServiceChannelCache:Ljava/util/HashMap;
    ...
    iput-object v3, p0, Landroid/server/BluetoothService;->mDeviceOobData:Ljava/util/HashMap;
    ...
    iput-object v3, p0, Landroid/server/BluetoothService;->mUuidIntentTracker:Ljava/util/ArrayList;
    ...
    iput-object v3, p0, Landroid/server/BluetoothService;->mUuidCallbackTracker:Ljava/util/HashMap;
    ...
    iput-object v3, p0, Landroid/server/BluetoothService;->mServiceRecordToPid:Ljava/util/HashMap;
    ...
    iput-object v3, p0, Landroid/server/BluetoothService;->mDeviceProfileState:Ljava/util/HashMap;

    .line 306
    new-instance v3, Landroid/bluetooth/BluetoothProfileState;

    iget-object v4, p0, Landroid/server/BluetoothService;->mContext:Landroid/content/Context;

    invoke-direct {v3, v4, v6}, Landroid/bluetooth/BluetoothProfileState;-><init>(Landroid/content/Context;I)V

    iput-object v3, p0, Landroid/server/BluetoothService;->mA2dpProfileState:Landroid/bluetooth/BluetoothProfileState;
    ...
    invoke-direct {v3, v4, v5}, Landroid/bluetooth/BluetoothProfileState;-><init>(Landroid/content/Context;I)V

    iput-object v3, p0, Landroid/server/BluetoothService;->mHfpProfileState:Landroid/bluetooth/BluetoothProfileState;

    .line 309
    iget-object v3, p0, Landroid/server/BluetoothService;->mHfpProfileState:Landroid/bluetooth/BluetoothProfileState;

    invoke-virtual {v3}, Landroid/bluetooth/BluetoothProfileState;->start()V
    ...
    iput-object v3, p0, Landroid/server/BluetoothService;->mPendingIntent:Landroid/app/PendingIntent;
    ...
    invoke-static {v3, p0}, Landroid/server/BluetoothInputProfileHandler;->getInstance(Landroid/content/Context;Landroid/server/BluetoothService;)Landroid/server/BluetoothInputProfileHandler;

    move-result-object v3

    iput-object v3, p0, Landroid/server/BluetoothService;->mBluetoothInputProfileHandler:Landroid/server/BluetoothInputProfileHandler;

    .line 323
    iget-object v3, p0, Landroid/server/BluetoothService;->mContext:Landroid/content/Context;

    invoke-static {v3, p0}, Landroid/server/BluetoothPanProfileHandler;->getInstance(Landroid/content/Context;Landroid/server/BluetoothService;)Landroid/server/BluetoothPanProfileHandler;

    move-result-object v3

    iput-object v3, p0, Landroid/server/BluetoothService;->mBluetoothPanProfileHandler:Landroid/server/BluetoothPanProfileHandler;

    .line 324
    iget-object v3, p0, Landroid/server/BluetoothService;->mContext:Landroid/content/Context;

    invoke-static {v3, p0}, Landroid/server/BluetoothHealthProfileHandler;->getInstance(Landroid/content/Context;Landroid/server/BluetoothService;)Landroid/server/BluetoothHealthProfileHandler;

    move-result-object v3

    iput-object v3, p0, Landroid/server/BluetoothService;->mBluetoothHealthProfileHandler:Landroid/server/BluetoothHealthProfileHandler;
    ...
    iput-object v3, p0, Landroid/server/BluetoothService;->mIncomingConnections:Ljava/util/HashMap;
    ...
    iput-object v3, p0, Landroid/server/BluetoothService;->mProfileConnectionState:Ljava/util/HashMap;
...
.method static synthetic access$100(Landroid/server/BluetoothService;)Z
    ...
    .prologue
    .line 114
    iget-boolean v0, p0, Landroid/server/BluetoothService;->mAllowConnect:Z
...
.method static synthetic access$1300(Landroid/server/BluetoothService;)Landroid/server/BluetoothAdapterStateMachine;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1600(Landroid/server/BluetoothService;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$200(Landroid/server/BluetoothService;)Landroid/app/AlertDialog;
    ...
    .prologue
    .line 114
    iget-object v0, p0, Landroid/server/BluetoothService;->mBtWfdDialog:Landroid/app/AlertDialog;
...
.method static synthetic access$202(Landroid/server/BluetoothService;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    ...
    .prologue
    .line 114
    iput-object p1, p0, Landroid/server/BluetoothService;->mBtWfdDialog:Landroid/app/AlertDialog;

    return-object p1
.end method

.method static synthetic access$300(Landroid/server/BluetoothService;)Landroid/os/HandlerThread;
    .locals 1
    .parameter "x0"

    .prologue
    .line 114
    iget-object v0, p0, Landroid/server/BluetoothService;->mWfdHandlerThread:Landroid/os/HandlerThread;

    return-object v0
.end method

.method static synthetic access$400(Landroid/server/BluetoothService;)V
    .locals 0
    .parameter "x0"

    .prologue
    .line 114
    invoke-direct {p0}, Landroid/server/BluetoothService;->wfdRejectEnable()V
...
.method static synthetic access$600(Landroid/server/BluetoothService;)Landroid/view/ContextThemeWrapper;
    .locals 1
    .parameter "x0"

    .prologue
    .line 114
    iget-object v0, p0, Landroid/server/BluetoothService;->mContextEmui:Landroid/view/ContextThemeWrapper;
...
.method static synthetic access$800(Landroid/server/BluetoothService;)Landroid/server/BluetoothBondState;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$900(Landroid/server/BluetoothService;II)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private handleWfdConflict()V
    .locals 2
    ...
    const-string v1, "handleWfdConflict"
    ...
    const-string v1, "WFDConflictThread"

    invoke-direct {v0, v1}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Landroid/server/BluetoothService;->mWfdHandlerThread:Landroid/os/HandlerThread;
    ...
    iget-object v1, p0, Landroid/server/BluetoothService;->mWfdHandlerThread:Landroid/os/HandlerThread;
...
.method private wfdRejectEnable()V
    .locals 6
    ...
    const-string/jumbo v2, "wfdRejectEnable"
...
.method public declared-synchronized enable(ZZ)Z
    ...
    :cond_1
    :try_start_1
    const-string/jumbo v8, "wlan.wfd.bt.exclude"
    ...
    .line 715
    .local v1, btExclude:Ljava/lang/String;
    ...
    .line 719
    .local v2, mWfdState:Z
    :goto_1
    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "enable: mWfdState = "
    ...
    invoke-static {v8}, Landroid/server/BluetoothService;->log(Ljava/lang/String;)V

    .line 720
    if-ne v7, v2, :cond_3

    .line 721
    invoke-direct {p0}, Landroid/server/BluetoothService;->handleWfdConflict()V
    ...
    .line 733
    .local v5, uid:I
    iget-object v8, p0, Landroid/server/BluetoothService;->mWirelessAndNetworkPermission:Lcom/huawei/permission/WirelessAndNetworkPermission;
    ...
    .line 741
    iget-object v6, p0, Landroid/server/BluetoothService;->mBluetoothState:Landroid/server/BluetoothAdapterStateMachine;
    ...
    invoke-virtual {v6, v8, v9}, Landroid/server/BluetoothAdapterStateMachine;->sendMessage(ILjava/lang/Object;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 706
    .end local v1           #btExclude:Ljava/lang/String;
    .end local v3           #old:I
...
.method public getRebootBluetoothState()Z
    ...
    .prologue
    .line 2200
    invoke-virtual {p0}, Landroid/server/BluetoothService;->getPersistedBluetoothState()Z
    ...
    const-string v2, "getRebootBluetoothState: bluetoothState = "
