...
.field private static final DEFAULT_IDLE_MS:J = 0x2bf20L
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 172
    iput-boolean v5, p0, Lcom/android/server/WifiService;->remindWifiToPdp:Z
    ...
    .line 245
    iput-boolean v5, p0, Lcom/android/server/WifiService;->mWifiOffForQb:Z
    ...
    .line 401
    iput-boolean v5, p0, Lcom/android/server/WifiService;->mWaitForScanResult:Z

    .line 402
    iput-boolean v5, p0, Lcom/android/server/WifiService;->mShowReselectDialog:Z

    .line 405
    iput-boolean v5, p0, Lcom/android/server/WifiService;->mWifiIpoOff:Z
    ...
    const-string v6, "hw_RemindWifiToPdp"

    invoke-static {v3, v6, v5}, Landroid/provider/SettingsEx$Systemex;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    :goto_0
    iput-boolean v3, p0, Lcom/android/server/WifiService;->remindWifiToPdp:Z

    .line 417
    new-instance v3, Lcom/huawei/permission/WirelessAndNetworkPermission;

    iget-object v6, p0, Lcom/android/server/WifiService;->mContext:Landroid/content/Context;

    invoke-direct {v3, v6}, Lcom/huawei/permission/WirelessAndNetworkPermission;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Lcom/android/server/WifiService;->mWirelessAndNetworkPermission:Lcom/huawei/permission/WirelessAndNetworkPermission;
...
.method private checkAndSetNotification()V
    ...
    const-string v10, "checkAndSetNotification, remindWifiToPdp:"

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget-boolean v10, p0, Lcom/android/server/WifiService;->remindWifiToPdp:Z
    ...
    iget-boolean v8, p0, Lcom/android/server/WifiService;->remindWifiToPdp:Z
...
.method private isPsDataAvailable()Z
    ...
    .line 2282
    :cond_2
    invoke-direct {p0}, Lcom/android/server/WifiService;->getMobileDataEnabled()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private setNotificationVisible(ZIZI)V
    ...
    const-string v5, "mNotification always set to null, default to 0"
...
.method private updateWifiState()V
    ...
    iget-boolean v6, p0, Lcom/android/server/WifiService;->mWifiOffForQb:Z
...
.method public declared-synchronized setWifiEnabled(Z)Z
    ...
    invoke-static {v4, v8, v9}, Landroid/provider/Settings$Global;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    .line 700
    .local v5, uid:I
    iget-object v8, p0, Lcom/android/server/WifiService;->mWirelessAndNetworkPermission:Lcom/huawei/permission/WirelessAndNetworkPermission;

    const/16 v9, 0x3e8

    invoke-virtual {v8, v9, v5}, Lcom/huawei/permission/WirelessAndNetworkPermission;->isBlocked(II)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v8, "Can\'t enable wifi when airplane mode is on for customization."

    invoke-static {v7, v8}, Lcom/mediatek/xlog/SXlog;->i(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 733
    iget-boolean v6, p0, Lcom/android/server/WifiService;->mIsReceiverRegistered:Z
