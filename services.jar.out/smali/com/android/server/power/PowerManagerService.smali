...
.field private static final BUTTON_OFF_TIMEOUT:I = 0xbb8
...
.field private static final USER_ACTIVITY_SCREEN_BUTTON_BRIGHT:I = 0x5
...
.method public constructor <init>()V
    ...
    .line 217
    iput-boolean v3, p0, Lcom/android/server/power/PowerManagerService;->mMMITestStart:Z
    ...
    .line 381
    iput v4, p0, Lcom/android/server/power/PowerManagerService;->mButtonBrightnessOverrideFromWindowManager:I
    ...
    .line 413
    iput-object v6, p0, Lcom/android/server/power/PowerManagerService;->mTvOut:Lcom/mediatek/common/tvout/ITVOUTNative;

    .line 393
    iput-boolean v3, p0, Lcom/android/server/power/PowerManagerService;->mIsQbShutdown:Z

    .line 394
    const-string v1, "android.intent.action.ACTION_QUICKBOOT_BOOT_COMPLETE"

    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->ACTION_QUICKBOOT_BOOT_COMPLETE:Ljava/lang/String;

    .line 395
    const-string v1, "android.intent.action.ACTION_QUICKBOOT_SHUTDOWN"

    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->ACTION_QUICKBOOT_SHUTDOWN:Ljava/lang/String;

    .line 396
    const-string v1, "android.intent.action.ACTION_QUICKBOOT_SCREENON"

    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->ACTION_QUICKBOOT_SCREENON:Ljava/lang/String;

    .line 397
    const-string v1, "android.intent.action.ACTION_QUICKBOOT_SCREENOFF"

    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->ACTION_QUICKBOOT_SCREENOFF:Ljava/lang/String;
...
.method private acquireWakeLockInternal(Landroid/os/IBinder;ILjava/lang/String;Landroid/os/WorkSource;II)V
    ...
    iput-boolean v2, p0, Lcom/android/server/power/PowerManagerService;->mMMITestStart:Z
...
.method private isPoweroffAlarmShutdown()Z
    ...
    invoke-direct {v3, p0}, Lcom/android/server/power/PowerManagerService$7;-><init>(Lcom/android/server/power/PowerManagerService;)V
...
.method private setTemporaryScreenAutoBrightnessAdjustmentSettingOverrideInternal(F)V
    ...
    const-string v3, "setTemporaryScreenAutoBrightnessAdjustmentSettingOverrideInternal adj = "
...
.method private shouldWakeUpWhenPluggedOrUnpluggedLocked(ZIZ)Z
    ...
    const-string v3, "persist.standby.value"
...
.method private updateDisplayPowerStateLocked(I)V
    ...
    iget v5, p0, Lcom/android/server/power/PowerManagerService;->mButtonBrightnessOverrideFromWindowManager:I
    ...
    iget-boolean v5, p0, Lcom/android/server/power/PowerManagerService;->mMMITestStart:Z

    if-nez v5, :cond_5

    .line 2027
    iget v5, p0, Lcom/android/server/power/PowerManagerService;->mButtonBrightness:I
    ...
    const-string v7, "set button light brightness : "
    ...
    .line 2022
    iget-object v5, p0, Lcom/android/server/power/PowerManagerService;->mPhoneWindowManager:Lcom/android/internal/policy/impl/PhoneWindowManager;

    invoke-virtual {v5}, Lcom/android/internal/policy/impl/PhoneWindowManager;->keyguardIsShowingTq()Z
    ...
    invoke-virtual {v5}, Lcom/android/server/power/DisplayPowerController;->getButtonAutoBrightness()I
...
.method private updateUserActivitySummaryLocked(JI)V
    ...
    iget-wide v11, p0, Lcom/android/server/power/PowerManagerService;->mLastWakeTime:J
    ...
    .line 1638
    .local v5, screenBrightTimeout:J
    cmp-long v9, p1, v0
    ...
    .line 1652
    .end local v0           #buttonTimeout:J
    .end local v5           #screenBrightTimeout:J
    :cond_0
    :goto_0
    iget v9, p0, Lcom/android/server/power/PowerManagerService;->mUserActivitySummary:I
    ...
    invoke-virtual {v9, v2, v3, v4}, Lcom/android/server/power/PowerManagerService$PowerManagerHandler;->sendMessageAtTime(Landroid/os/Message;J)Z
    ...
    .line 1641
    .restart local v0       #buttonTimeout:J
    .restart local v3       #nextTimeout:J
    .restart local v5       #screenBrightTimeout:J
...
.method public setPolicy(Landroid/view/WindowManagerPolicy;)V
    ...
    iput-object v0, p0, Lcom/android/server/power/PowerManagerService;->mPhoneWindowManager:Lcom/android/internal/policy/impl/PhoneWindowManager;
...
.method public systemReady(Lcom/android/server/TwilightService;Lcom/android/server/dreams/DreamManagerService;)V
    ...
    .line 648
    move-object/from16 v0, p0
    invoke-direct {v0}, Lcom/android/server/power/PowerManagerService;->registerQbReceiver()V
