...
# static fields
.field private static final ACTION_BATTERY_TEMP_ABNORMAL:Ljava/lang/String; = "org.huawei.android.action.BATTERY_TEMP_ABNORMAL"

.field private static final ACTION_BATTERY_TEMP_NORMAL:Ljava/lang/String; = "org.huawei.android.action.BATTERY_TEMP_NORMAL"

.field private static final ACTION_CHARGE_VOLTAGE:Ljava/lang/String; = "org.huawei.android.action.CHARGE_VOLTAGE"

.field private static final ACTION_CHARGE_VOLTAGE_OKAY:Ljava/lang/String; = "org.huawei.android.action.CHARGE_VOLTAGE_OKAY"
...
.field private static final BATTERY_TEMP_DOWN:I = 0x0

.field private static final BATTERY_TEMP_DOWN_SHUTDOWN:I = -0xc8

.field private static final BATTERY_TEMP_OVER:I = 0x1f4

.field private static final BATTERY_TEMP_OVER_SHUTDOWN:I = 0x258
...
.field private static final TEMP_PROTECT_MAX_VALUE:I = 0x258

.field private static final TEMP_PROTECT_MIN_VALUE:I = -0xc8

.field private static final TEMP_PROTECT_NV_ITEM:I = 0x2d
...
.field private mLastChargeVol:I
...
.field private mSentChargeVoltageBroadcast:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/LightsService;)V
    ...
    .line 176
    iput-boolean v2, p0, Lcom/android/server/BatteryService;->mSentChargeVoltageBroadcast:Z

    .line 177
    iput-boolean v2, p0, Lcom/android/server/BatteryService;->mSentBatteryTempAbnormalBroadcast:Z
...
.method static synthetic access$802(Lcom/android/server/BatteryService;Z)Z
    ...
    .prologue
    .line 87
    iput-boolean p1, p0, Lcom/android/server/BatteryService;->mSentBatteryTempAbnormalBroadcast:Z
...
.method private processValuesLocked()V
    ...
    iget v0, p0, Lcom/android/server/BatteryService;->mChargeVol:I

    iget v1, p0, Lcom/android/server/BatteryService;->mLastChargeVol:I
    ...
    iget-boolean v0, p0, Lcom/android/server/BatteryService;->mSentChargeVoltageBroadcast:Z
    ...
    iget v0, p0, Lcom/android/server/BatteryService;->mBatteryTempStatus:I

    const/4 v1, 0x1

    if-ne v0, v1, :cond_d

    iget-boolean v0, p0, Lcom/android/server/BatteryService;->mSentBatteryTempAbnormalBroadcast:Z
    ...
    iput v0, p0, Lcom/android/server/BatteryService;->mLastChargeVol:I
...
.method private shutdownIfOverTempLocked()V
    ...
    .line 337
    .local v1, overTempProtectEnabled:Z
    new-instance v0, Landroid/app/NvramGetSet;

    invoke-direct {v0}, Landroid/app/NvramGetSet;-><init>()V

    .line 338
    .local v0, nvGetSet:Landroid/app/NvramGetSet;
    new-array v2, v5, [B
    ...
    invoke-virtual {v0, v2, v3, v5, v5}, Landroid/app/NvramGetSet;->readNV([BIII)Z
    ...
    .line 358
    .end local v0           #nvGetSet:Landroid/app/NvramGetSet;
    .end local v1           #overTempProtectEnabled:Z
    .end local v2           #tpRead:[B
    :cond_2
    return-void
.end method
