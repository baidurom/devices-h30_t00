...
# static fields
.field private static final MAX_MAIN_PARSER:I = 0x14
...
.method private ParserEvents(Ljava/lang/String;)I
    ...
    .line 163
    .local v3, stoke:Ljava/util/StringTokenizer;
    ...
    iput-wide v6, p0, Lcn/real/device/assparser/JSsaParser;->mParserCounts:J

    .line 167
    iget-wide v6, p0, Lcn/real/device/assparser/JSsaParser;->mParserCounts:J
    ...
    .line 168
    iput v5, p0, Lcn/real/device/assparser/JSsaParser;->mParserThreads:I

    .line 169
    iget-wide v6, p0, Lcn/real/device/assparser/JSsaParser;->mParserCounts:J

    sput-wide v6, Lcn/real/device/assparser/JSsaParser;->mCountsMainThread:J
    ...
    .line 181
    iget-object v6, p0, Lcn/real/device/assparser/JSsaParser;->mFormat:Lcn/real/device/assparser/SsaFormat;

    invoke-virtual {v6, v0}, Lcn/real/device/assparser/SsaFormat;->SetEventFormat(Ljava/lang/String;)V
    ...
    .line 204
    :goto_2
    iget-object v6, p0, Lcn/real/device/assparser/JSsaParser;->mMultiThreadHandler:Landroid/os/Handler;

    iget-object v7, p0, Lcn/real/device/assparser/JSsaParser;->mMultiThreadTask:Ljava/lang/Runnable;
    ...
    const-string v8, "#########Parser completed from 0 to "
    ...
    .line 172
    .end local v1           #hasParseredNum:I
    :cond_2
    const/4 v6, 0x2

    iput v6, p0, Lcn/real/device/assparser/JSsaParser;->mParserThreads:I
    ...
    sput-wide v6, Lcn/real/device/assparser/JSsaParser;->mCountsPerThread:J

    goto :goto_1

    .line 185
    .restart local v1       #hasParseredNum:I
    :cond_3
    invoke-virtual {v3}, Ljava/util/StringTokenizer;->nextToken()Ljava/lang/String;
    ...
    invoke-virtual {v6, v0}, Lcn/real/device/assparser/SsaFormat;->GetEventContent(Ljava/lang/String;)Lcn/real/device/assparser/SsaContent;
    ...
    .line 192
    iget-object v6, p0, Lcn/real/device/assparser/JSsaParser;->mData:Lcn/real/device/assparser/SsaData;

    invoke-virtual {v6, v4}, Lcn/real/device/assparser/SsaData;->Insert(Lcn/real/device/assparser/SsaContent;)V

    .line 200
    :goto_3
    int-to-long v6, v1

    sget-wide v8, Lcn/real/device/assparser/JSsaParser;->mCountsMainThread:J
    ...
    const-string v7, "####Get Invalid Event Content####"
