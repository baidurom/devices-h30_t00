...
# static fields
.field private static final ADD_DURATION:I = 0x1f4

.field private static final DEF_DURATION:I = 0x7d0

.field private static final DEF_PARSER_TIME:I = 0xc8

.field private static final HELIXLOG:Ljava/lang/String; = "HelixSubtitleService"

.field private static final MAX_FONT_SIZE:F = 44.0f

.field private static final MAX_PARSER_TIME:I = 0x2710

.field private static final MIN_DURATION:I = 0x3e8

.field private static final MIN_GAP_TIME:I = 0x1
...
.method private ResetSubtitleViewState()V
    ...
    sget v2, Lcn/real/device/FileUtils;->mSurfaceWidth:I

    invoke-virtual {v1, v2}, Lcn/real/device/SubTitleView;->setWidth(I)V
    ...
    invoke-virtual {v1, v2}, Lcn/real/device/SubTitleView;->setBitmap(Landroid/graphics/Bitmap;)V
    ...
    .line 468
    iget v1, p0, Lcn/real/device/HelixSubtitleService;->mSubTitleType:I
    ...
    invoke-virtual {v1, v4}, Lcn/real/device/SubTitleView;->setBackgroundColor(I)V
    ...
    invoke-virtual {v1}, Lcn/real/device/SubTitleView;->getLineCount()I

    move-result v1

    iget v2, p0, Lcn/real/device/HelixSubtitleService;->mDefaultFontHeight:I
    ...
    invoke-virtual {v1, v0}, Lcn/real/device/SubTitleView;->setHeight(I)V
    ...
    iget v2, p0, Lcn/real/device/HelixSubtitleService;->mDefaultFontSize:F

    sget v3, Lcn/real/device/FileUtils;->mScaleX:F

    mul-float/2addr v2, v3

    invoke-virtual {v1, v2}, Lcn/real/device/SubTitleView;->setTextSize(F)V
    ...
    invoke-virtual {v1, v4}, Lcn/real/device/SubTitleView;->setVisibility(I)V
...
.method public OnPlay()V
    ...
    .line 229
    iput-boolean v7, p0, Lcn/real/device/HelixSubtitleService;->mClosed:Z

    .line 230
    iput-boolean v7, p0, Lcn/real/device/HelixSubtitleService;->mActiveByOther:Z
    ...
    :cond_0
    :goto_0
    iput-boolean v7, p0, Lcn/real/device/HelixSubtitleService;->mPaused:Z
    ...
    .line 251
    iput-boolean v7, p0, Lcn/real/device/HelixSubtitleService;->mPreSeeked:Z
...
.method public SetMediaURL(Ljava/lang/String;)I
    ...
    .line 106
    const-string v2, "HelixSubtitleService"

    new-instance v3, Ljava/lang/StringBuilder;

    const-string v4, "####Begin Init Parser"

    invoke-direct {v3, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v4, p0, Lcn/real/device/HelixSubtitleService;->mFilePath:Ljava/lang/String;
    ...
    iput v2, p0, Lcn/real/device/HelixSubtitleService;->mSubTitleType:I

    .line 109
    new-instance v2, Lcn/real/device/srtparser/JSrtParser;

    iget-object v3, p0, Lcn/real/device/HelixSubtitleService;->mFilePath:Ljava/lang/String;

    invoke-direct {v2, v3}, Lcn/real/device/srtparser/JSrtParser;-><init>(Ljava/lang/String;)V

    sput-object v2, Lcn/real/device/HelixSubtitleService;->mSrtParser:Lcn/real/device/srtparser/JSrtParser;

    .line 111
    :try_start_0
    sget-object v2, Lcn/real/device/HelixSubtitleService;->mSrtParser:Lcn/real/device/srtparser/JSrtParser;

    invoke-virtual {v2}, Lcn/real/device/srtparser/JSrtParser;->DoParser()I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "####End Init Parser and return ="
    ...
    .line 118
    new-instance v2, Lcn/real/device/smiparser/JSmiParser;

    iget-object v3, p0, Lcn/real/device/HelixSubtitleService;->mFilePath:Ljava/lang/String;

    invoke-direct {v2, v3}, Lcn/real/device/smiparser/JSmiParser;-><init>(Ljava/lang/String;)V

    sput-object v2, Lcn/real/device/HelixSubtitleService;->mSmiParser:Lcn/real/device/smiparser/JSmiParser;

    .line 120
    :try_start_1
    sget-object v2, Lcn/real/device/HelixSubtitleService;->mSmiParser:Lcn/real/device/smiparser/JSmiParser;

    invoke-virtual {v2}, Lcn/real/device/smiparser/JSmiParser;->DoParser()I
    :try_end_1
    ...
    .line 127
    new-instance v2, Lcn/real/device/subidxparser/JSubIdxParser;

    iget-object v3, p0, Lcn/real/device/HelixSubtitleService;->mFilePath:Ljava/lang/String;

    invoke-direct {v2, v3}, Lcn/real/device/subidxparser/JSubIdxParser;-><init>(Ljava/lang/String;)V

    sput-object v2, Lcn/real/device/HelixSubtitleService;->mSubIdxParser:Lcn/real/device/subidxparser/JSubIdxParser;

    .line 129
    :try_start_2
    sget-object v2, Lcn/real/device/HelixSubtitleService;->mSubIdxParser:Lcn/real/device/subidxparser/JSubIdxParser;

    invoke-virtual {v2}, Lcn/real/device/subidxparser/JSubIdxParser;->DoParser()I
    ...
    .line 131
    new-instance v2, Lcn/real/device/subidxparser/VobSubFileHandler;

    iget-object v3, p0, Lcn/real/device/HelixSubtitleService;->mFilePath:Ljava/lang/String;

    invoke-direct {v2, v3}, Lcn/real/device/subidxparser/VobSubFileHandler;-><init>(Ljava/lang/String;)V

    iput-object v2, p0, Lcn/real/device/HelixSubtitleService;->mSubFileHandler:Lcn/real/device/subidxparser/VobSubFileHandler;
    :try_end_2
    ...
    .line 139
    new-instance v2, Lcn/real/device/assparser/JSsaParser;

    iget-object v3, p0, Lcn/real/device/HelixSubtitleService;->mFilePath:Ljava/lang/String;

    invoke-direct {v2, v3}, Lcn/real/device/assparser/JSsaParser;-><init>(Ljava/lang/String;)V

    sput-object v2, Lcn/real/device/HelixSubtitleService;->mSsaParser:Lcn/real/device/assparser/JSsaParser;

    .line 141
    :try_start_3
    sget-object v2, Lcn/real/device/HelixSubtitleService;->mSsaParser:Lcn/real/device/assparser/JSsaParser;

    invoke-virtual {v2}, Lcn/real/device/assparser/JSsaParser;->DoParser()I
    :try_end_3
...
.method public SetSurfaceViewSize(II)V
    ...
    const-string v6, "=========SetSurfaceViewSize========="
    ...
    .line 486
    .local v0, dynamicScale:F
    const/4 v1, 0x0

    .line 487
    .local v1, fontSize:F
    iget-object v5, p0, Lcn/real/device/HelixSubtitleService;->mPlayer:Landroid/media/MediaPlayer;
    ...
    iput v5, p0, Lcn/real/device/HelixSubtitleService;->mVideoWidth:I
    ...
    iput v5, p0, Lcn/real/device/HelixSubtitleService;->mVideoHeight:I
    ...
    iget v5, p0, Lcn/real/device/HelixSubtitleService;->mVideoWidth:I

    if-eqz v5, :cond_1

    iget v5, p0, Lcn/real/device/HelixSubtitleService;->mVideoHeight:I
    ...
    const-string v7, "due to some parameter is =0; so setFontSize = "

    invoke-direct {v6, v7}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget v7, p0, Lcn/real/device/HelixSubtitleService;->mDefaultFontSize:F
    ...
    .line 493
    iget-object v5, p0, Lcn/real/device/HelixSubtitleService;->mDisplayView:Landroid/view/View;

    check-cast v5, Lcn/real/device/SubTitleView;

    iget v6, p0, Lcn/real/device/HelixSubtitleService;->mDefaultFontHeight:I

    invoke-virtual {v5, v6}, Lcn/real/device/SubTitleView;->setHeight(I)V
    ...
    iget v6, p0, Lcn/real/device/HelixSubtitleService;->mDefaultFontSize:F

    invoke-virtual {v5, v6}, Lcn/real/device/SubTitleView;->setTextSize(F)V
    ...
    :cond_4
    :goto_2
    sget v5, Lcn/real/device/FileUtils;->mScaleX:F

    iput v5, p0, Lcn/real/device/HelixSubtitleService;->mLastScaleX:F

    .line 508
    sput v0, Lcn/real/device/FileUtils;->mScaleX:F

    .line 509
    invoke-static {p1, p2}, Lcn/real/device/FileUtils;->SetSurfaceSize(II)V
    ...
    invoke-virtual {v5, p1}, Lcn/real/device/SubTitleView;->setWidth(I)V

    .line 512
    iget v5, p0, Lcn/real/device/HelixSubtitleService;->mSubTitleType:I
    ...
    invoke-virtual {v5, v9}, Lcn/real/device/SubTitleView;->setBackgroundColor(I)V

    .line 514
    iget-object v5, p0, Lcn/real/device/HelixSubtitleService;->mSubFileHandler:Lcn/real/device/subidxparser/VobSubFileHandler;
    ...
    invoke-virtual {v5}, Lcn/real/device/subidxparser/VobSubFileHandler;->GetHeight()I

    move-result v2

    .line 516
    .local v2, high:I
    sget v5, Lcn/real/device/FileUtils;->mDefaultSTViewHight:I
    ...
    :cond_7
    sget v2, Lcn/real/device/FileUtils;->mDefaultSTViewHight:I
    ...
    invoke-virtual {v5}, Lcn/real/device/SubTitleView;->getLineCount()I

    move-result v5

    int-to-float v5, v5

    iget v6, p0, Lcn/real/device/HelixSubtitleService;->mLastScaleX:F
    ...
    .line 525
    :cond_9
    iget v5, p0, Lcn/real/device/HelixSubtitleService;->mDefaultFontHeight:I
    ...
    invoke-virtual {v5, v6}, Lcn/real/device/SubTitleView;->setVisibility(I)V
    ...
    invoke-virtual {v5, v4}, Lcn/real/device/SubTitleView;->setHeight(I)V
    ...
    invoke-virtual {v5, v9}, Lcn/real/device/SubTitleView;->setVisibility(I)V
...
.method public SetView(Landroid/view/View;)I
    ...
    .line 537
    iget-object v2, p0, Lcn/real/device/HelixSubtitleService;->mDisplayView:Landroid/view/View;
    ...
    const-string v3, "####SubTitle DisplayView not defined yet!####"
