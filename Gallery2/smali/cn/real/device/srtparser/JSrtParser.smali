...
# static fields
.field private static final MAX_FILE_SIZE:I = 0x4b000

.field private static final MAX_MAIN_PARSER:I = 0x64
...
.method private IsFileExists()Z
    ...
    iget-object v1, p0, Lcn/real/device/srtparser/JSrtParser;->mFilePath:Ljava/lang/String;
...
.method private IsNotTimeStamp(Ljava/lang/String;)Z
    ...
    .line 224
    .local v0, isTime:Ljava/lang/String;
    :goto_0
    if-nez v0, :cond_1
    ...
    .line 223
    .end local v0           #isTime:Ljava/lang/String;
    :cond_0
    const/4 v0, 0x0
    ...
    .line 224
    .restart local v0       #isTime:Ljava/lang/String;
    :cond_1
    const/4 v3, 0x0
