...
.field private static final mMaxBits:I = 0x800

.field private static final mSize:I = 0x1000
...
.method private GetHeaderLength(JZ)I
    .locals 12
    .parameter "filepos"
    .parameter "firstTime"
    ...
    .line 236
    .local v2, extendSize:I
    const/4 v6, 0x0

    .line 237
    .local v6, mPacketSize:I
    const/4 v5, 0x0

    .line 238
    .local v5, mDataPacketSize:I
    new-array v3, v0, [B

    .line 241
    .local v3, head:[B
    :try_start_0
    iget-object v9, p0, Lcn/real/device/subidxparser/VobSubFileHandler;->mFileHandler:Ljava/io/RandomAccessFile;

    invoke-virtual {v9, p1, p2}, Ljava/io/RandomAccessFile;->seek(J)V
    ...
    invoke-virtual {v9, v3, v10, v0}, Ljava/io/RandomAccessFile;->read([BII)I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private SetDuration(I)V
    ...
    iput-wide v0, p0, Lcn/real/device/subidxparser/VobSubFileHandler;->mDuration:J
...
.method public GetBuffer()[B
    ...
    .prologue
    .line 66
    iget-object v0, p0, Lcn/real/device/subidxparser/VobSubFileHandler;->buffer:[B
...
.method public GetWidth()I
    ...
    .prologue
    .line 70
    iget v0, p0, Lcn/real/device/subidxparser/VobSubFileHandler;->mDisplayW:I
