...
.method public constructor <init>()V
    ...
    .prologue
    .line 36
    .local p0, this:Lcom/google/gson/internal/ParameterizedTypeHandlerMap;,"Lcom/google/gson/internal/ParameterizedTypeHandlerMap<TT;>;"
...
.method private appendList(Ljava/lang/StringBuilder;Ljava/util/List;)V
    ...
    .line 219
    .local p0, this:Lcom/google/gson/internal/ParameterizedTypeHandlerMap;,"Lcom/google/gson/internal/ParameterizedTypeHandlerMap<TT;>;"
    .local p2, list:Ljava/util/List;,"Ljava/util/List<Lcom/google/gson/internal/Pair<Ljava/lang/Class<*>;TT;>;>;"
    const/4 v1, 0x1
    ...
    .line 221
    .local v0, entry:Lcom/google/gson/internal/Pair;,"Lcom/google/gson/internal/Pair<Ljava/lang/Class<*>;TT;>;"
    if-eqz v1, :cond_0
    ...
    invoke-direct {p0, v3}, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->typeToString(Ljava/lang/reflect/Type;)Ljava/lang/String;
    ...
    .line 229
    .end local v0           #entry:Lcom/google/gson/internal/Pair;,"Lcom/google/gson/internal/Pair<Ljava/lang/Class<*>;TT;>;"
    :cond_1
    return-void
.end method
...
.method private getHandlerForTypeHierarchy(Ljava/lang/Class;Z)Ljava/lang/Object;
    ...
    .line 163
    .local v0, entry:Lcom/google/gson/internal/Pair;,"Lcom/google/gson/internal/Pair<Ljava/lang/Class<*>;TT;>;"
    iget-object v2, v0, Lcom/google/gson/internal/Pair;->first:Ljava/lang/Object;
    ...
    .line 164
    iget-object v2, v0, Lcom/google/gson/internal/Pair;->second:Ljava/lang/Object;
    ...
    .line 169
    .restart local v0       #entry:Lcom/google/gson/internal/Pair;,"Lcom/google/gson/internal/Pair<Ljava/lang/Class<*>;TT;>;"
    iget-object v2, v0, Lcom/google/gson/internal/Pair;->first:Ljava/lang/Object;
...
.method private static getIndexOfAnOverriddenHandler(Ljava/lang/Class;Ljava/util/List;)I
    ...
    .local p1, typeHierarchyList:Ljava/util/List;,"Ljava/util/List<Lcom/google/gson/internal/Pair<Ljava/lang/Class<*>;TT;>;>;"
...
.method private static getIndexOfSpecificHandlerForTypeHierarchy(Ljava/lang/Class;Ljava/util/List;)I
    ...
    check-cast v1, Lcom/google/gson/internal/Pair;

    iget-object v1, v1, Lcom/google/gson/internal/Pair;->first:Ljava/lang/Object;
...
# virtual methods
.method public declared-synchronized copyOf()Lcom/google/gson/internal/ParameterizedTypeHandlerMap;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 197
    .local v0, copy:Lcom/google/gson/internal/ParameterizedTypeHandlerMap;,"Lcom/google/gson/internal/ParameterizedTypeHandlerMap<TT;>;"
    ...
    .line 191
    .end local v0           #copy:Lcom/google/gson/internal/ParameterizedTypeHandlerMap;,"Lcom/google/gson/internal/ParameterizedTypeHandlerMap<TT;>;"
    :catchall_0
    move-exception v1
...
.method public declared-synchronized getHandlerFor(Ljava/lang/reflect/Type;Z)Ljava/lang/Object;
    ...
    .line 139
    :try_start_0
    iget-object v3, p0, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->userMap:Ljava/util/Map;
    ...
    :cond_0
    :try_start_1
    iget-object v3, p0, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->systemMap:Ljava/util/Map;
    ...
    .line 150
    invoke-virtual {p0, v2, p2}, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->getHandlerFor(Ljava/lang/reflect/Type;Z)Ljava/lang/Object;
    ...
    .restart local v0       #handler:Ljava/lang/Object;,"TT;"
    :cond_2
    invoke-direct {p0, v2, p2}, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->getHandlerForTypeHierarchy(Ljava/lang/Class;Z)Ljava/lang/Object;
    :try_end_1
...
.method public declared-synchronized makeUnmodifiable()Lcom/google/gson/internal/ParameterizedTypeHandlerMap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public declared-synchronized register(Ljava/lang/reflect/Type;Ljava/lang/Object;Z)V
    ...
    :try_start_0
    iget-boolean v1, p0, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->modifiable:Z
    ...
    .line 93
    sget-object v1, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->logger:Ljava/util/logging/Logger;
...
.method public declared-synchronized registerForTypeHierarchy(Lcom/google/gson/internal/Pair;Z)V
    .locals 6
    .parameter
    .parameter "isSystem"
    .annotation system Ldalvik/annotation/Signature;
    ...
    .line 58
    .local p0, this:Lcom/google/gson/internal/ParameterizedTypeHandlerMap;,"Lcom/google/gson/internal/ParameterizedTypeHandlerMap<TT;>;"
    .local p1, pair:Lcom/google/gson/internal/Pair;,"Lcom/google/gson/internal/Pair<Ljava/lang/Class<*>;TT;>;"
    monitor-enter p0

    :try_start_0
    iget-boolean v2, p0, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->modifiable:Z
    ...
    .line 62
    .local v1, typeHierarchyList:Ljava/util/List;,"Ljava/util/List<Lcom/google/gson/internal/Pair<Ljava/lang/Class<*>;TT;>;>;"
    :goto_0
    iget-object v2, p1, Lcom/google/gson/internal/Pair;->first:Ljava/lang/Object;

    check-cast v2, Ljava/lang/Class;

    invoke-static {v2, v1}, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->getIndexOfSpecificHandlerForTypeHierarchy(Ljava/lang/Class;Ljava/util/List;)I
    ...
    invoke-static {v2, v1}, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->getIndexOfAnOverriddenHandler(Ljava/lang/Class;Ljava/util/List;)I
    ...
    check-cast v2, Lcom/google/gson/internal/Pair;

    iget-object v2, v2, Lcom/google/gson/internal/Pair;->first:Ljava/lang/Object;
    ...
    .end local v1           #typeHierarchyList:Ljava/util/List;,"Ljava/util/List<Lcom/google/gson/internal/Pair<Ljava/lang/Class<*>;TT;>;>;"
    :cond_2
    ...
    .restart local v1       #typeHierarchyList:Ljava/util/List;,"Ljava/util/List<Lcom/google/gson/internal/Pair<Ljava/lang/Class<*>;TT;>;>;"
    :cond_3
    const/4 v2, 0x0
...
.method public declared-synchronized registerForTypeHierarchy(Ljava/lang/Class;Ljava/lang/Object;Z)V
    ...
    .line 54
    .local v0, pair:Lcom/google/gson/internal/Pair;,"Lcom/google/gson/internal/Pair<Ljava/lang/Class<*>;TT;>;"
    ...
    .line 53
    .end local v0           #pair:Lcom/google/gson/internal/Pair;,"Lcom/google/gson/internal/Pair<Ljava/lang/Class<*>;TT;>;"
    :catchall_0
    move-exception v1
...
.method public declared-synchronized registerIfAbsent(Lcom/google/gson/internal/ParameterizedTypeHandlerMap;)V
    .locals 8
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .line 100
    .local p0, this:Lcom/google/gson/internal/ParameterizedTypeHandlerMap;,"Lcom/google/gson/internal/ParameterizedTypeHandlerMap<TT;>;"
    .local p1, other:Lcom/google/gson/internal/ParameterizedTypeHandlerMap;,"Lcom/google/gson/internal/ParameterizedTypeHandlerMap<TT;>;"
    monitor-enter p0

    :try_start_0
    iget-boolean v5, p0, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->modifiable:Z
    ...
    :cond_0
    :try_start_1
    iget-object v5, p1, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->userMap:Ljava/util/Map;
    ...
    iget-object v5, p0, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->userMap:Ljava/util/Map;
    ...
    invoke-virtual {p0, v5, v6, v7}, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->register(Ljava/lang/reflect/Type;Ljava/lang/Object;Z)V
    ...
    :cond_2
    iget-object v5, p1, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->systemMap:Ljava/util/Map;
    ...
    iget-object v5, p0, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->systemMap:Ljava/util/Map;
    ...
    .end local v1           #entry:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/reflect/Type;TT;>;"
    :cond_4
    iget-object v5, p1, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->userTypeHierarchyList:Ljava/util/List;
    ...
    .line 117
    .local v0, entry:Lcom/google/gson/internal/Pair;,"Lcom/google/gson/internal/Pair<Ljava/lang/Class<*>;TT;>;"
    iget-object v5, v0, Lcom/google/gson/internal/Pair;->first:Ljava/lang/Object;

    check-cast v5, Ljava/lang/Class;

    iget-object v6, p0, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->userTypeHierarchyList:Ljava/util/List;

    invoke-static {v5, v6}, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->getIndexOfSpecificHandlerForTypeHierarchy(Ljava/lang/Class;Ljava/util/List;)I
    ...
    invoke-virtual {p0, v0, v5}, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->registerForTypeHierarchy(Lcom/google/gson/internal/Pair;Z)V
    ...
    :cond_6
    iget-object v5, p1, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->systemTypeHierarchyList:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/google/gson/internal/ParameterizedTypeHandlerMap;->systemTypeHierarchyList:Ljava/util/List;
