...
.method private constructor <init>(Lcom/google/gson/internal/bind/MiniGson$Builder;)V
    ...
    .line 41
    new-instance v2, Lcom/google/gson/internal/bind/MiniGson$1;

    invoke-direct {v2, p0}, Lcom/google/gson/internal/bind/MiniGson$1;-><init>(Lcom/google/gson/internal/bind/MiniGson;)V

    iput-object v2, p0, Lcom/google/gson/internal/bind/MiniGson;->calls:Ljava/lang/ThreadLocal;
    ...
    .line 52
    .local v0, constructorConstructor:Lcom/google/gson/internal/ConstructorConstructor;
    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    .line 53
    .local v1, factories:Ljava/util/List;,"Ljava/util/List<Lcom/google/gson/internal/bind/TypeAdapter$Factory;>;"
    ...
    iput-object v2, p0, Lcom/google/gson/internal/bind/MiniGson;->factories:Ljava/util/List;
...
# virtual methods
.method public getAdapter(Lcom/google/gson/reflect/TypeToken;)Lcom/google/gson/internal/bind/TypeAdapter;
    .locals 9
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    iget-object v6, p0, Lcom/google/gson/internal/bind/MiniGson;->calls:Ljava/lang/ThreadLocal;
    ...
    .line 83
    .local v5, threadCalls:Ljava/util/Map;,"Ljava/util/Map<Lcom/google/gson/reflect/TypeToken<*>;Lcom/google/gson/internal/bind/MiniGson$FutureTypeAdapter<*>;>;"
    invoke-interface {v5, p1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lcom/google/gson/internal/bind/MiniGson$FutureTypeAdapter;

    .line 84
    .local v4, ongoingCall:Lcom/google/gson/internal/bind/MiniGson$FutureTypeAdapter;,"Lcom/google/gson/internal/bind/MiniGson$FutureTypeAdapter<TT;>;"
    if-eqz v4, :cond_0

    .line 100
    .end local v4           #ongoingCall:Lcom/google/gson/internal/bind/MiniGson$FutureTypeAdapter;,"Lcom/google/gson/internal/bind/MiniGson$FutureTypeAdapter<TT;>;"
    :goto_0
    return-object v4

    .line 88
    .restart local v4       #ongoingCall:Lcom/google/gson/internal/bind/MiniGson$FutureTypeAdapter;,"Lcom/google/gson/internal/bind/MiniGson$FutureTypeAdapter<TT;>;"
    :cond_0
    new-instance v0, Lcom/google/gson/internal/bind/MiniGson$FutureTypeAdapter;

    invoke-direct {v0}, Lcom/google/gson/internal/bind/MiniGson$FutureTypeAdapter;-><init>()V

    .line 89
    .local v0, call:Lcom/google/gson/internal/bind/MiniGson$FutureTypeAdapter;,"Lcom/google/gson/internal/bind/MiniGson$FutureTypeAdapter<TT;>;"
    invoke-interface {v5, p1, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 91
    :try_start_0
    iget-object v6, p0, Lcom/google/gson/internal/bind/MiniGson;->factories:Ljava/util/List;
    ...
    invoke-interface {v2, p0, p1}, Lcom/google/gson/internal/bind/TypeAdapter$Factory;->create(Lcom/google/gson/internal/bind/MiniGson;Lcom/google/gson/reflect/TypeToken;)Lcom/google/gson/internal/bind/TypeAdapter;

    move-result-object v1

    .line 93
    .local v1, candidate:Lcom/google/gson/internal/bind/TypeAdapter;,"Lcom/google/gson/internal/bind/TypeAdapter<TT;>;"
    if-eqz v1, :cond_1

    .line 94
    invoke-virtual {v0, v1}, Lcom/google/gson/internal/bind/MiniGson$FutureTypeAdapter;->setDelegate(Lcom/google/gson/internal/bind/TypeAdapter;)V
    :try_end_0
    ...
    .line 98
    .end local v1           #candidate:Lcom/google/gson/internal/bind/TypeAdapter;,"Lcom/google/gson/internal/bind/TypeAdapter<TT;>;"
...
.method public getAdapter(Ljava/lang/Class;)Lcom/google/gson/internal/bind/TypeAdapter;
    .locals 1
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public getNextAdapter(Lcom/google/gson/internal/bind/TypeAdapter$Factory;Lcom/google/gson/reflect/TypeToken;)Lcom/google/gson/internal/bind/TypeAdapter;
    .locals 7
    .parameter "skipPast"
    .parameter
    .annotation system Ldalvik/annotation/Signature;
    ...
    iget-object v4, p0, Lcom/google/gson/internal/bind/MiniGson;->factories:Ljava/util/List;
    ...
    .line 115
    .local v1, factory:Lcom/google/gson/internal/bind/TypeAdapter$Factory;
    if-nez v3, :cond_1
    ...
    .line 122
    :cond_1
    invoke-interface {v1, p0, p2}, Lcom/google/gson/internal/bind/TypeAdapter$Factory;->create(Lcom/google/gson/internal/bind/MiniGson;Lcom/google/gson/reflect/TypeToken;)Lcom/google/gson/internal/bind/TypeAdapter;

    move-result-object v0

    .line 123
    .local v0, candidate:Lcom/google/gson/internal/bind/TypeAdapter;,"Lcom/google/gson/internal/bind/TypeAdapter<TT;>;"
    if-eqz v0, :cond_0
    ...
    .line 128
    .end local v0           #candidate:Lcom/google/gson/internal/bind/TypeAdapter;,"Lcom/google/gson/internal/bind/TypeAdapter<TT;>;"
    .end local v1           #factory:Lcom/google/gson/internal/bind/TypeAdapter$Factory;
    :cond_2
