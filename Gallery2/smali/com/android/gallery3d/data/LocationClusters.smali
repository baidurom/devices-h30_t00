.class public Lcom/android/gallery3d/data/LocationClusters;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/gallery3d/data/LocationClusters$SmallItemClient;,
...
# static fields
.field private static final TAG:Ljava/lang/String; = "LocationClusters"

.field private static final mDateComparator:Ljava/util/Comparator;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 30
    new-instance v0, Lcom/android/gallery3d/data/LocationClusters$1;

    invoke-direct {v0}, Lcom/android/gallery3d/data/LocationClusters$1;-><init>()V

    sput-object v0, Lcom/android/gallery3d/data/LocationClusters;->mDateComparator:Ljava/util/Comparator;
...
.method public constructor <init>(Lcom/android/gallery3d/app/GalleryApp;Lcom/android/gallery3d/data/ClusterAlbumSet;Lcom/android/gallery3d/data/MediaSet;Lcom/android/gallery3d/data/Path;)V
    ...
    .line 121
    iput-object p1, p0, Lcom/android/gallery3d/data/LocationClusters;->mApplication:Lcom/android/gallery3d/app/GalleryApp;

    .line 122
    iput-object p3, p0, Lcom/android/gallery3d/data/LocationClusters;->mBaseSet:Lcom/android/gallery3d/data/MediaSet;
    ...
    iput-object v0, p0, Lcom/android/gallery3d/data/LocationClusters;->mClusterWorker:Lcom/android/gallery3d/data/ClusterWorker;

    .line 124
    iget-object v0, p0, Lcom/android/gallery3d/data/LocationClusters;->mClusterWorker:Lcom/android/gallery3d/data/ClusterWorker;

    const-string v1, "LocationClusters"
    ...
    sget-object v1, Lcom/android/gallery3d/data/LocationClusters;->mDateComparator:Ljava/util/Comparator;
    ...
    invoke-virtual {v0, v1}, Lcom/android/gallery3d/data/ClusterWorker;->setAlbumCompartor(Ljava/util/Comparator;)V

    .line 127
    iget-object v0, p0, Lcom/android/gallery3d/data/LocationClusters;->mClusterWorker:Lcom/android/gallery3d/data/ClusterWorker;

    new-instance v1, Lcom/android/gallery3d/data/LocationClusters$SmallItemClient;

    invoke-interface {p1}, Lcom/android/gallery3d/app/GalleryApp;->getAndroidContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, v2}, Lcom/android/gallery3d/data/LocationClusters$SmallItemClient;-><init>(Landroid/content/Context;)V
...
.method static synthetic access$000(Lcom/android/gallery3d/data/LocationClusters;)Lcom/android/gallery3d/data/MediaSet;
    .locals 1
    .parameter "x0"

    .prologue
    .line 21
    iget-object v0, p0, Lcom/android/gallery3d/data/LocationClusters;->mBaseSet:Lcom/android/gallery3d/data/MediaSet;

    return-object v0
.end method

.method static synthetic access$100(Lcom/android/gallery3d/data/LocationClusters;)Lcom/android/gallery3d/data/ClusterWorker;
    .locals 1
    .parameter "x0"
...
.method public getMediaItems(I)Ljava/util/ArrayList;
    ...
    .prologue
    .line 134
    iget-object v1, p0, Lcom/android/gallery3d/data/LocationClusters;->mClusterWorker:Lcom/android/gallery3d/data/ClusterWorker;
...
.method public reload()Lcom/android/gallery3d/util/Future;
    ...
    .prologue
    .line 160
    iget-object v0, p0, Lcom/android/gallery3d/data/LocationClusters;->mApplication:Lcom/android/gallery3d/app/GalleryApp;

    invoke-interface {v0}, Lcom/android/gallery3d/app/GalleryApp;->getThreadPool()Lcom/android/gallery3d/util/ThreadPool;

    move-result-object v0

    new-instance v1, Lcom/android/gallery3d/data/LocationClusters$2;

    invoke-direct {v1, p0}, Lcom/android/gallery3d/data/LocationClusters$2;-><init>(Lcom/android/gallery3d/data/LocationClusters;)V
